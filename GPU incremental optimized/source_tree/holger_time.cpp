...
char * * timing_str = (char * *) malloc(sizeof(char *)*MAX_TIME_STREAMS*MAX_TIMINGS_PER_STREAM);
...
void holger_time_start(int idx, char * str) {
	timings_n[idx] = 0;
	holger_time(idx, str);
}

void holger_time(int idx, char * str) {
